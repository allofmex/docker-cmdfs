#!/usr/bin/env bash
TARGETPATH_ALL="/hostTarget/photos_all"
TARGETPATH_LAND="/hostTarget/photos_landscape"
...
term_handler() {
  ...
  umount -f $TARGETPATH_LAND
  umount -f $TARGETPATH_ALL
...
cmdfs /hostSource $TARGETPATH_ALL -s -o "extension=jpg;jpeg;gif;png,monitor,command=$MY_PATH/img_filter.sh,cache-dir=$CACHE_DIR,cache-size=$CACHE,allow_other"
cmdfs /hostTarget/photos_all $TARGETPATH_LAND -s \
